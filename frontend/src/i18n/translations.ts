...
export const TRANSLATIONS = {
  ...
  zh: {
    ...
    historySearch: '历史搜索',
    historySearchPlaceholder: '按关键词或ID片段搜索...',
    popularKeywords: '高频关键词',
    textMode: '纯文字题',
    imageMode: '图表题',
    analysisMode: '数据分析题',
    originalPaperLabel: '原始论文',
    latexDownload: '下载 LaTeX 代码',
